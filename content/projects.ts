...
export const projects: Project[] = [
  ...
  },
  {
    ...
    statement: "An academic modelling study focused on preparation, regularisation and cautious interpretation—not a validated medical system.",
  ...
  },
  {
    ...
    statement: "A model comparison designed to examine generalisation, preprocessing sensitivity and group fairness—not only a winning score.",
