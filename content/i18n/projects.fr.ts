...
const frenchProjects: Record<string, ProjectTranslation> = {
  ...
  "support2-mortality-analysis": {
    ...
    statement: "Une étude académique centrée sur la préparation, la régularisation et l’interprétation prudente.",
  ...
  "customer-churn-models": {
    ...
    statement: "Une comparaison conçue pour étudier généralisation, sensibilité au preprocessing et équité entre groupes.",
